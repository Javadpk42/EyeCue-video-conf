...
//               <Link to='/user/signin' className='text-custom hover:font-bold'>Click here</Link>
//             </div>
//           </form>
//         </div>
//       </div>
...
import { signupUser, googleAuthLogin } from '../../api/userApi';
...
export default function SignUp() {
  ...
  const handleGoogleSuccess = async (codeResponse) => {
    try {
      ...
      const response = await googleAuthLogin(access_token);
  ...
  return (
    <div className="h-screen">
      <div className="border-b-2 py-4">
        <div className="container mx-auto flex justify-between items-center">
          <Link to='/user' className="text-3xl font-bold tracking-tight text-custom">EyeCue</Link>
        </div>
      </div>
      <div className="flex flex-col md:flex-row">
        <div className="w-1/4 flex justify-center items-center">
      ...
      <form className="w-11/12 md:w-80 flex flex-col gap-4 md:mt-44 ml-40" onSubmit={formik.handleSubmit}>
        ...
        <div className="relative mb-2">
          ...
          />
          {formik.touched.username && formik.errors.username && (
            <div className="absolute text-error text-sm mt-1">{formik.errors.username}</div>
          )}
        </div>
        ...
        <div className='mt-4 text-center'>
              <span>Already have an account? </span>
              <Link to='/user/signin' className='text-custom hover:font-bold'>Sign In</Link>
            </div>
      </form>
    </div>
      </div>
